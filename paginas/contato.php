...
<div class="container">
    ...
    <h1> Contatos</h1><br>
    <p>  Entre em contatos com nosssa secretatria e retire suas dúvidas.</p>
    ...
    <form>
        ...
        <div class="form-group">
            <label for="exampleFormControlInput1"></label>
            <input type="email" class="form-control" id="exampleFormControlInput1" placeholder="O Seu email*">
        </div>
        ...
        <img src="public/img/mapas.jpg" class="img-fluid" alt="Imagem responsiva">
