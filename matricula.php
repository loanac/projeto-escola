...
<body>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-transparent">
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav">
                    ...
                    <a class="nav-item nav-link" href="#">Matrícula</a>
        ...
        <section class="matric1">
            <div class="row">
                <div class="col text-center">
                    <img class="w-50" src="public/img/iconfinderclock.png" alt="">
                </div>
                <div class="col">
                    <br>
                    <h2 class="text-light">ALUNOS VETERANOS</h2>
                    <p class="text-light">02 de novembro de 2020 a 29 de novembro de 2020</p>
                    <br>
                    <br>
                    <br>
                    <h2 class="text-light">ALUNOS NOVATOS</h2>
                    <p class="text-light">01 de novembro de 2020 a 30 de dezembro de 2020</p>
                </div>
            </div>
        </section>
    </div>
    <div class="container">
        <section class="sec2">
            ...
            <div class="row">
                <div class="col">
                    <ul>
                        <li> Ficha de Cadastro preenchida;</li>
                        <li> Ficha médica do aluno;</li>
                        <li> Comprovante de residência;</li>
                        <li> Cópia do CPF, RG (Responsável financeiro)</li>
                        <li> Atestado de aptidão física (a partir do 1º ano do ensino fundamental) </li>
                    </ul>
                </div>
                <div class="col">
                    <img class="w-75" src="public/img/ilustracoes.png" alt="">
                </div>
                <div class="col">
                    <ul>
                        <li> Cópia do RG ou registro de nascimento do aluno;</li>
                        <li> Histórico ou declaração provisória (aluno novato);</li>
                        <li> Foto 3x4;</li>
                        <li> Assinatura do contrato de prestação de serviços educacionais 2020.</li>
                    </ul>
                </div>
            </div>
        </section>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col">
                <div class="card border-danger mb-3" style="max-width: 18rem;">
                    <div class="card-header"> <strong>Educação Infantil</strong> <small>(I ano)</small> </div>
                    <div class="card-body text-danger">
                        <p class="card-text text-center"><small>R$</small> <strong>420</strong> <small>00</small></p>
                    </div>
                </div>
            </div>
            <div class="col">
                <div class="card border-danger mb-3" style="max-width: 18rem;">
                    <div class="card-header"> <strong>Ensino Fundamental I</strong> <small>(1º ao 5º ano)</small></div>
                    <div class="card-body text-danger">
                        <p class="card-text text-center"><small>R$</small> <strong>400</strong> <small>00</small></p>
                    </div>
                </div>
            </div>
            <div class="col">
                <div class="card border-danger mb-3" style="max-width: 18rem;">
                    <div class="card-header"> <strong>Ensino Fundamental II <small>(6º ano)</small></strong></div>
                    <div class="card-body text-danger">
                        <p class="card-text text-center"><small>R$</small> <strong>420</strong> <small>00</small></p>
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col">
                <div class="card border-danger mb-3" style="max-width: 18rem;">
                    <div class="card-header"> <strong>Educação Infantil</strong> <small>(II ao IV ano)</small> </div>
                    <div class="card-body text-danger">
                        <p class="card-text text-center"><small>R$</small> <strong>420</strong> <small>00</small></p>
                    </div>
                </div>
            ...
            <div class="col">
                <div class="card border-danger mb-3" style="max-width: 18rem;">
                    <div class="card-header"> <strong>Ensino Fundamental II</strong><small> (7º ao 9º)</small></div>
                    <div class="card-body text-danger">
                        <p class="card-text text-center"><small>R$</small> <strong>420</strong> <small>00</small></p>
                    </div>
                </div>
